...
<head>
    ...
    <title>Sewa Mobil App - Register</title>
    ...
    <link href="{{ asset('backend/vendor/quill/quill.bubble.cs') }}s" rel="stylesheet">
    <link href="{{ asset('backend/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/vendor/simple-datatables/style.cs') }}s" rel="stylesheet">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">Rental Mobil App</span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="credits">
                                ...
                                Copyright &copy; <a href="https://localhost/sewa-mobil/public">Rental Mobil App</a>
                            </div>
