    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 mb-5">
            <div class="card h-100">
                <!-- Product image-->
                <img class="card-img-top" src="{{ asset(Storage::url($car->gambar)) }}" alt="{{ $car->nama_mobil }}" />
                <!-- Product details-->
        ...
        <div class="col-lg-4 mb-5">
            <div class="card">
                ...
                <div class="card-body card-body-custom pt-4">
                    <div class="text-center">
                        ...
                        <ul class="list-unstyled list-style-group">
                            ...
                            <li class="border-bottom p-2 d-flex justify-content-between">
                                <span>Transmisi</span>
                                <span style="font-weight: 600">{{ $car->tranmisi }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-footer border-top-0 bg-transparent">
                    <div class="text-center">
                        <a class="btn d-flex align-items-center justify-content-center btn-primary mt-auto" href=""
                            style="column-gap: 0.4rem">Sewa Mobil <i class="ri-whatsapp-line"></i></a>
                    </div>
                </div>
            </div>
        </div>
